...
STAT_NAMES = {
    ...
    "cri": ("Crítico", "Basico"),
    "pot": ("Potencia", "Atributo"),
    "al": ("Alineación", "Basico"),
    "inv": ("Invocación", "Basico"),
    "da": ("Daño", "Daño"),
    # Daños especiales
    "da_neu": ("Daño Neutro", "Daño"),
    "da_tierra": ("Daño Tierra", "Daño"),
    "da_fuego": ("Daño Fuego", "Daño"),
    "da_agua": ("Daño Agua", "Daño"),
    "da_aire": ("Daño Aire", "Daño"),
    "da_cri": ("Daño Crítico", "Daño"),
    "da_tram": ("Daño Trampa", "Daño"),
    "da_emp": ("Daño Empeño", "Daño"),
    ...
    "re_cri": ("Res. Críticos", "Resistencia"),
    # Especiales
    "cu": ("Cura", "Especial"),
    "pla": ("Placaje", "Especial"),
    "hui": ("Huida", "Especial"),
    "prospe": ("Prosperidad", "Especial"),
    "ini": ("Iniciativa", "Especial"),
    "pa": ("PA", "Basico"),
    "pm": ("PM", "Basico"),
    "ret_pa": ("Retiro PA", "Especial"),
    "ret_pm": ("Retiro PM", "Especial"),
    "es_pa": ("Esquiva PA", "Especial"),
    "es_pm": ("Esquiva PM", "Especial"),
}
